        ...
        <main className="flex-1 px-6 md:px-10 py-8 md:py-10 flex flex-col">
          ...
          <div className="relative mb-12">
            <div className="bg-amber-50 rounded-full flex relative h-14 items-center px-1">
              <div
                className={`absolute top-1 bottom-1 w-1/2 rounded-full bg-amber-600/90 transition-transform duration-300 ease-out ${
                  isLogin ? "translate-x-0" : "translate-x-full"
                }`}
              />
              <button
                type="button"
                className={`hover:cursor-pointer relative z-10 flex-1 text-base md:text-lg font-semibold ${
                  isLogin ? "text-white" : "text-amber-700"
                }`}
